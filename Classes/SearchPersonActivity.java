...
public class SearchPersonActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Person person = getPerson(firstName.toLowerCase(), lastName.toLowerCase());
        int ID = getID(firstName.toLowerCase(), lastName.toLowerCase());
        ...
        if (personExists) {
            ...
            TextView text1 = (TextView) findViewById(R.id.textView1);
            text1.setText("Could not find person");
        }
    ...
    public Person getPerson(String personFirstName, String personLastName) {
        ...
        try {
            ...
            cursor = db.query("SANTASLIST",
                    ...
                    "lower(FirstName) = ? OR lower(LastName) = ?",
